       ...
       <div className='home-page'>
         ...
         <div className='home-page_box'>
           <div className='home-page_module_3'>
             ...
             <img
               className='module3_pic'
               src={
                 require('../../assets/image/home/module3_pic_' +
                   this.state.language +
                   '@2x.png').default
               }
             />
             <img
               className='module3_pic_h5'
               src={
                 require('../../assets/image/home/module3_pic_h5_' +
                   this.state.language +
                   '@2x.png').default
               }
             />
         ...
         <div className='home-page_module_4'>
           ...
           <div className='right_content'>
             ...
             <img
               style={{ width: '228px', height: '198px' }}
               className='left_pic_h5'
               src={Right_Pic_H5}
             />
           </div>
         </div>
